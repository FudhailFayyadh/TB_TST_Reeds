...
class TestProfileEndpointsAuth:
    ...
    def test_create_profile_with_auth(self, client, auth_headers, demo_user_credentials):
    ...
    def test_get_profile_without_auth(self, client, auth_headers, demo_user_credentials):
...
class TestProfileEndpointsAuthorization:
    ...
    def test_user_cannot_create_other_profile(self, client, user1_headers, user2_auth):
        ...
        response = client.post(f"/profile/{user2_auth['user_id']}", headers=user1_headers)
    ...
    def test_user_cannot_view_other_profile(self, client, user1_headers, user2_auth):
        ...
        response = client.get(f"/profile/{user2_auth['user_id']}", headers=user1_headers)
        assert response.status_code == 403
...
class TestProfileEndpointsCRUD:
    ...
    def test_add_max_5_genres(self, client, test_user):
        ...
        for genre in genres:
            client.post(f"/profile/{user_id}/genre", headers=headers, json={"genre": genre})
        
        # Try 6th genre
        response = client.post(
            f"/profile/{user_id}/genre",
            headers=headers,
            json={"genre": "Drama"}
        )
    ...
    def test_get_profile(self, client, test_user):
        ...
        # Populate profile
        client.post(f"/profile/{user_id}/genre", headers=headers, json={"genre": "Fantasy"})
        client.post(f"/profile/{user_id}/rating", headers=headers, json={"book_id": "book-001", "rating": 5})
        client.post(f"/profile/{user_id}/block", headers=headers, json={"book_id": "bad-book"})
    ...
    def test_get_snapshot(self, client, test_user):
        ...
        client.post(f"/profile/{user_id}/genre", headers=headers, json={"genre": "Fantasy"})
        client.post(f"/profile/{user_id}/rating", headers=headers, json={"book_id": "book-001", "rating": 5})
        client.post(f"/profile/{user_id}/rating", headers=headers, json={"book_id": "book-002", "rating": 3})
    ...
    def test_get_snapshot_unauthorized(self, client, test_user):
        ...
        response = client.get(f"/profile/{other_user_id}/snapshot", headers=test_user["headers"])
        assert response.status_code == 403
...
class TestProfileWorkflow:
    ...
    def test_complete_user_workflow(self, client):
        ...
        # 4. Add preferences
        client.post(f"/profile/{user_id}/genre", headers=headers, json={"genre": "Fantasy"})
        client.post(f"/profile/{user_id}/genre", headers=headers, json={"genre": "Sci-Fi"})
