...
class TestAuthControllerUnit:
    ...
    def test_register_duplicate_username(self, client):
        ...
        response = client.post(
            "/auth/register", json={"username": "testuser", "password": "different123"}
        )
    ...
    def test_login_success_form(self, client):
        ...
        response = client.post(
            "/auth/login", data={"username": "demo_user", "password": "demo123"}
        )
    ...
    def test_login_wrong_password(self, client):
        ...
        response = client.post(
            "/auth/login", data={"username": "demo_user", "password": "wrongpassword"}
        )
    ...
    def test_login_json_success(self, client):
        ...
        response = client.post(
            "/auth/token", json={"username": "demo_user", "password": "demo123"}
        )
    ...
    def test_login_json_invalid_credentials(self, client):
        ...
        response = client.post(
            "/auth/token", json={"username": "demo_user", "password": "wrongpassword"}
        )
...
class TestProfileControllerUnit:
    ...
    def test_create_profile_success(self, client, auth_headers):
        ...
        response = client.post("/profile/user_001", headers=auth_headers)
    ...
    def test_create_profile_unauthorized(self, client, auth_headers):
        ...
        response = client.post("/profile/different_user", headers=auth_headers)
    ...
    def test_get_profile_success(self, client, auth_headers):
        ...
        response = client.get("/profile/user_001", headers=auth_headers)
    ...
    def test_get_profile_unauthorized(self, client, auth_headers):
        ...
        response = client.get("/profile/other_user", headers=auth_headers)
    ...
    def test_add_genre_success(self, client, auth_headers):
        ...
        response = client.post(
            "/profile/user_001/genre", headers=auth_headers, json={"genre": "Fiction"}
        )
    ...
    def test_add_genre_max_5(self, client, auth_headers):
        ...
        # Try to add 6th
        response = client.post(
            "/profile/user_001/genre", headers=auth_headers, json={"genre": "Genre6"}
        )
    ...
    def test_get_snapshot_success(self, client, auth_headers):
        ...
        response = client.get("/profile/user_001/snapshot", headers=auth_headers)
    ...
    def test_get_snapshot_unauthorized(self, client, auth_headers):
        ...
        response = client.get("/profile/other_user/snapshot", headers=auth_headers)
