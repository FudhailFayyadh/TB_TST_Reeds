...
@pytest.fixture
def second_user_token(client: TestClient, second_user_credentials: Dict[str, str]) -> str:
...
@pytest.fixture
def created_profile(client: TestClient, auth_headers: Dict[str, str], demo_user_credentials: Dict[str, str]) -> str:
